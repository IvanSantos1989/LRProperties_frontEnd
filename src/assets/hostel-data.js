...
export const hostelData = [
...

  {
    ...
    image13: img57,
    image14: img58,
    descrição: `This cozy yet well-appointed apartment is located just steps from Porto's iconic Clérigos Tower, 
        providing the perfect base for exploring the city while enjoying modern comforts and a touch of outdoor space. 
        Situated near Clérigos Tower, this apartment places you in the heart of Porto's historical district, 
        within walking distance of many attractions like the Livraria Lello, Ribeira district, and São Bento Station. 
        The area is brimming with restaurants, cafes, shops, and nightlife, yet the apartment offers a tranquil retreat from the city's lively energy.`,

    descrição2: `Inside and Layout - One Bedroom: A well-designed bedroom with a comfortable double or queen-size bed, high-quality linens, and ample closet space. 
        Large windows in the bedroom might provide natural light and views of the city.`,

    descrição3: `Kitchen: The apartment features a compact but fully equipped kitchen 
        with modern appliances such as a stove, oven, fridge, and microwave, perfect for preparing meals or enjoying coffee. 
        The kitchen includes basic cookware and dining utensils.`,

    descrição4: `Bathroom: A modern bathroom with a walk-in shower, fresh towels, and essential toiletries for guest use.`,

    descrição5: `Balcony: The standout feature of this apartment is its private balcony, offering a peaceful outdoor space. 
        Whether it provides a view of the bustling streets below or a quiet courtyard, 
...

  {
    ...
    image26: img84,
    image27: img85,
    descrição: `Spacious and Quiet Urban Retreat - This apartment, located in the heart of Porto near the Clérigos Tower, offers the rare combination of urban proximity and serenity. 
        Though it sits within one of the city's most iconic and lively neighborhoods, it promises a quiet environment perfect for relaxation. 
        Being steps away from the Clérigos Tower, the apartment offers easy access to Porto's main attractions—Livraria Lello, São Bento Station, the Porto Cathedral, and the lively Ribeira district. 
        Numerous cafes, restaurants, and shopping options are right at your doorstep, but the apartment remains a calm oasis to return to after a day in the vibrant city. 
        This apartment is ideal for those seeking a spacious, comfortable, and quiet retreat in the heart of Porto, combining the best of both convenience and tranquility.`,
    ...
    descrição4: `Kitchen: Fully equipped kitchen with modern appliances (e.g., stove, fridge, microwave, dishwasher), offering everything needed for preparing meals. 
        There might also be a dining area, allowing for a home-cooked dinner experience.`,

    descrição5: `Bathrooms: Likely equipped with at least one modern bathroom featuring a shower or bathtub, with premium towels and toiletries provided for guests' comfort.`,

    descrição6: `Silent Escape: Despite being in a bustling part of the city, the apartment ensures peace and quiet, 
